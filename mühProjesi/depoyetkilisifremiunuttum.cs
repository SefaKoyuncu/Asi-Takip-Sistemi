...
{
    public partial class depoyetkilisifremiunuttum : Form
    {
        public depoyetkilisifremiunuttum()
        {
            InitializeComponent();
        }
        ...
        private void depoyetkilisifremiunuttum_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (textBoxsifregir1.Text == textBoxsifregir2.Text)
            {
                try
                {
                    ...
                    MySqlCommand komut = new MySqlCommand("update asidepoyetkilibilgileri set Şifre = '" + textBoxsifregir1.Text + "' where TC like  '" + maskedtxtBoxTC.Text + "'", baglanti);
                    MySqlDataReader reader = komut.ExecuteReader();
